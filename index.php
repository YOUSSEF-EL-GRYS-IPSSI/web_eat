...
<div class="container site">
    ...
    foreach ($categories as $categorie) {
        ...
        if ($categorie['id'] == 1)
            ...
            echo  '<li class="nav-item" role="presentation"> <a href="tab' . $categorie['id'] . '" class="nav-link active" data-bs-toggle="pill" data-bs-target="#tab1" role="tab">' . $categorie['name'] . '</a> </li>';
        else
            echo  '<li class="nav-item" role="presentation"> <a href="tab' . $categorie['id'] . '" class="nav-link" data-bs-toggle="pill" data-bs-target="#tab1" role="tab">' . $categorie['name'] . '</a> </li>';
    }
